                ...
                extends: [
                    {
                        rule: 'ht.ui.View',
                        categoryId: 'basic', 
                        filter: ['id', 'background', 'border', 'padding', 'borderRadius', 'preferredSize', 'minSize', 'maxSize', 'cursor', 'style', 'boxShadow', 'contextMenuUrl', 'disabled', 'is:visible', 'drawableState']
                    }
                ]
            },
            {
