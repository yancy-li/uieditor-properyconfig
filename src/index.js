...
import hButtonGroupProperties from './prop-config/hbuttongroup';
import vButtonGroupProperties from './prop-config/vbuttongroup';
...
window.uiEditorPropertyConfig = function(uiEditor) {
    ...
    properties.push(hButtonGroupProperties(uiEditor));
    ...
    properties.push(vButtonGroupProperties(uiEditor));
